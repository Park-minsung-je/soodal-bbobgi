        ...
        for (log in logs) {
            ...
            swimLogDao.insert(
                SwimLogEntity(
                    ...
                    strokeFreestyleM = log.distance * log.free / 100,
                    strokeBreastM = log.distance * log.breast / 100,
                    strokeBackM = log.distance * log.back / 100,
                    strokeFlyM = log.distance * log.fly / 100,
