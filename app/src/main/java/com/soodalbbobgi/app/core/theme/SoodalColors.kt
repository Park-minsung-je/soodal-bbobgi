...
val LightColors = SoodalColors(
    ...
    accentBlue = Color(0xFF2563EB), accentBlueSoft = Color(0xFF2563EB).copy(alpha = 0.16f),
    ...
    gradBlue = gradientBrush(listOf(Color(0xFF38BDF8), Color(0xFF2563EB))),
    ...
    glowBlue = Color(0xFF2563EB).copy(alpha = 0.16f),
...
val NeonColors = SoodalColors(
    ...
    accentBlue = Color(0xFF0A84FF), accentBlueSoft = Color(0xFF0A84FF).copy(alpha = 0.14f),
    ...
    gradBlue = gradientBrush(listOf(Color(0xFF5AC8FF), Color(0xFF0A84FF))),
    ...
    glowBlue = Color(0xFF0A84FF).copy(alpha = 0.18f),
...
val CalmColors = SoodalColors(
    ...
    glassBg = Color.White.copy(alpha = 0.06f),
    glassBorder = Color.White.copy(alpha = 0.12f),
    accentBlue = Color(0xFF60A5FA), accentBlueSoft = Color(0xFF60A5FA).copy(alpha = 0.14f),
    ...
    success = Color(0xFF30D158), warn = Color(0xFFFF6B6B),
    textPrimary = Color(0xFFE8EAF6), textSecondary = Color(0xFF8892A4), textTertiary = Color(0xFF4A5568),
    gradBlue = gradientBrush(listOf(Color(0xFF93C5FD), Color(0xFF60A5FA))),
    ...
    glowBlue = Color(0xFF60A5FA).copy(alpha = 0.16f),
...
val PastelColors = SoodalColors(
    ...
    glassBg = Color.White.copy(alpha = 0.06f),
    glassBorder = Color.White.copy(alpha = 0.12f),
    accentBlue = Color(0xFF93C5FD), accentBlueSoft = Color(0xFF93C5FD).copy(alpha = 0.14f),
    ...
    gradBlue = gradientBrush(listOf(Color(0xFFBFDBFE), Color(0xFF93C5FD))),
    ...
    glowBlue = Color(0xFF93C5FD).copy(alpha = 0.22f),
