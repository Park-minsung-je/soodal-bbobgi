...
data class SoodalColors(
    ...
    val gradBlue: Brush,
    /** 진한 하늘색 그라데이션 — 편집·기록 시트의 저장 버튼과 확인 팝업의 안전한 쪽(취소) 버튼. 연한 [gradBlue]보다 또렷하다. */
    val gradBlueVivid: Brush,
    val gradGold: Brush,
...
val LightColors = SoodalColors(
    ...
    gradBlueVivid = gradientBrush(listOf(Color(0xFF38BDF8), Color(0xFF2563EB))),
